...
val libraryPackage          = "${libraryNamespace}.kapp.data.compose"
...
android {
    namespace = "com.lucasferreiramachado.kapp.data.compose"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "com.lucasferreiramachado.kapp.data.compose"
...
compose.desktop {
    application {
        mainClass = "com.lucasferreiramachado.kapp.data.compose.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "com.lucasferreiramachado.kapp.data.compose"
