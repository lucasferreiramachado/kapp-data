...
val frameworkLibraryName    = "KAppDataUser" // execute gradle clean after changed it
val libraryArtifact         = "kapp-data-user"
val libraryPackage          = "${libraryNamespace}.kapp.data.user"
