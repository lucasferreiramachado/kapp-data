...
val frameworkLibraryName    = "KAppData" // execute gradle clean after changed it
val libraryArtifact         = "kapp-data"
val libraryPackage          = "${libraryNamespace}.kapp.data"
...
android {
    namespace = "io.github.lucasferreiramachado.kapp.data.core"
